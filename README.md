...
1. Run the evaluation.py to get the val.json

   ```
   val_dir = "./data/coco/val2014"  # 你验证集图片的目录
   generate_val_json(val_dir, model_name="coco", use_beam_search=False, output_file="val.json")
   ```
2. Run the eval_tool/coco_eval_example.py to look the metric

   ![1729085773277](image/README/1729085773277.png)
...
```
git clone https://github.com/wuyuan5896/clip-image-cpation.git
